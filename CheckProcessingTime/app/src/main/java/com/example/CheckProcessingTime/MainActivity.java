package com.example.CheckProcessingTime;
...
public class MainActivity extends AppCompatActivity implements SensorEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String fileName = "processingTime.csv";
        ...
        try{
            ...
            //ヘッダーを作成する
            pw.print("ProcessStartTime");
            pw.print(",");
            pw.print("ProcessEndTime");
            pw.print(",");
            pw.print("FilterStartTime");
            pw.print(",");
            pw.print("FilterEndTime");
            pw.print(",");
    ...
    public void onSensorChanged(SensorEvent event){
        ...
        long endTimeFilter = System.nanoTime();

        //double resultTime = (endTimeFilter - startTimeFilter) / 1000000000D;
        //Log.i("filterTime", "measure : " + resultTime);
        ...
        double ax_after = sensorAccel[0] + 9.8f * Math.sin(Math.toRadians(rpy[1]));
        double ay_after = sensorAccel[1] - 9.8f * Math.cos(Math.toRadians(rpy[1])) * Math.sin(Math.toRadians(rpy[0]));
        double az_after = sensorAccel[2] - 9.8f * Math.cos(Math.toRadians(rpy[1])) * Math.cos(Math.toRadians(rpy[0]));
        ...
        double processTime = (endTime - startTime) / 1000000000D;
        double filterTime = (endTimeFilter - startTimeFilter) / 1000000000D;


        pw.print(startTime + ",");
        pw.print(endTime + ",");
        pw.print(startTimeFilter + ",");
        pw.print(endTimeFilter + ",");
        pw.print(processTime + ",");
        pw.print(filterTime + ",");
        pw.println();


        //Log.i("process time", "time = " + result);
