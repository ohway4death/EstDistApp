package com.example.MadgwickGravityDistFile;
...
public class MainActivity extends AppCompatActivity implements SensorEventListener{
    ...
    public void onSensorChanged(SensorEvent event){
        ...
        sensorAccel[0] = sensorAccelBef[0] * 0.9f + sensorAccel[0] * 0.1f;
        sensorAccel[1] = sensorAccelBef[1] * 0.9f + sensorAccel[1] * 0.1f;
        sensorAccel[2] = sensorAccelBef[2] * 0.9f + sensorAccel[2] * 0.1f;
        ...
        /*
        axNotGrav = axNotGravBef * 0.9 + axNotGrav * 0.1;
        ayNotGrav = ayNotGravBef * 0.9 + ayNotGrav * 0.1;
        azNotGrav = azNotGravBef * 0.9 + azNotGrav * 0.1;
         */
        ...
        double accelNotGrav[] = {axNotGrav, ayNotGrav, azNotGrav};
        double accelGlobal [] = {ax_global, ay_global, az_global};

        textViewPeriod.setText(String.valueOf(dif));
        textViewDistance.setText(String.valueOf(rungeKutta(accelGlobal, dif)));
