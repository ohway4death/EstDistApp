...
public class MainActivity extends AppCompatActivity implements SensorEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String fileName = "AccelFixed.csv";
    ...
    public void onSensorChanged(SensorEvent event){
        ...
        switch (event.sensor.getType()){
            case Sensor.TYPE_ACCELEROMETER:
                ...
                sensorAccelFixed[0] = sensorAccel[0] * (1 - a) + sensorAccelBef[0] * a;
                sensorAccelFixed[1] = sensorAccel[1] * (1 - a) + sensorAccelBef[1] * a;
                sensorAccelFixed[2] = sensorAccel[2] * (1 - a) + sensorAccelBef[2] * a;
                ...
                pw.print(",");
                pw.print(sensorAccelFixed[0]);
                pw.print(",");
                pw.print(sensorAccelFixed[1]);
                pw.print(",");
                pw.print(sensorAccelFixed[2]);
                pw.println();
