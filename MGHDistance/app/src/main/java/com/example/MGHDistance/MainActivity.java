package com.example.MGHDistance;
...
*/
                ...
                String fileName = "stopMotionErrorCheck.csv";
...
*/
                ...
                double accelVec = Math.sqrt(Math.pow(ax_global,2) + Math.pow(ay_global,2));

                queueAccel.add(accelVec);
